...
function [ output_args ] = quickAnalysisFixed( singlePlot )
% when singlePlot is true, everything is plot as a 2x4 panel figure
...
errorbar(x,dapiMM,dapiSS);
title([analysisParam.channelNames{plotChannels} ' : dapi'])
ylabel('pixel intensity');
xlabel('hours Wnt');
if ~singlePlot
